...
class Ui_FF_Widget(object):
    def setupUi(self, FF_Widget):
        ...
        self.he_pump_led = QtWidgets.QRadioButton(parent=FF_Widget)
...
"}")
        ...
        self.he_pump_led.setCheckable(True)
        self.he_pump_led.setChecked(False)
        self.he_pump_led.setObjectName("he_pump_led")
        self.input_valve_led = QtWidgets.QRadioButton(parent=FF_Widget)
...
"}")
        ...
        self.output_valve_led = QtWidgets.QRadioButton(parent=FF_Widget)
...
"}")
        ...
        self.output_valve_led.setCheckable(True)
        ...
        self.output_pump_led = QtWidgets.QRadioButton(parent=FF_Widget)
...
"}")
        ...
        self.output_pump_led.setCheckable(True)
        self.output_pump_led.setChecked(False)
        self.output_pump_led.setObjectName("output_pump_led")
        self.high_level_led = QtWidgets.QRadioButton(parent=FF_Widget)
...
"}")
        ...
        self.high_level_led.setCheckable(True)
        self.high_level_led.setChecked(False)
        self.high_level_led.setObjectName("high_level_led")
        self.low_level_led = QtWidgets.QRadioButton(parent=FF_Widget)
...
"}")
        ...
        self.low_level_led.setCheckable(True)
        ...
        self.he_input_led = QtWidgets.QRadioButton(parent=FF_Widget)
...
"}")
        ...
        self.he_input_led.setCheckable(True)
...
"}")
        ...
        self.he_output_led = QtWidgets.QRadioButton(parent=FF_Widget)
...
"}")
        ...
        self.he_output_led.setCheckable(True)
        self.he_output_led.setChecked(False)
        self.he_output_led.setObjectName("he_output_led")
        self.co2_valve_led = QtWidgets.QRadioButton(parent=FF_Widget)
