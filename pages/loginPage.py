...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.login)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.passwd)
        self.log_in_button = QtWidgets.QPushButton(parent=self.formLayoutWidget)
        self.log_in_button.setObjectName("log_in_button")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.log_in_button)
        self.clear_button = QtWidgets.QPushButton(parent=self.formLayoutWidget)
        self.clear_button.setObjectName("clear_button")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.clear_button)
        self.server_ip = QtWidgets.QLineEdit(parent=self.formLayoutWidget)
        self.server_ip.setInputMethodHints(QtCore.Qt.InputMethodHint.ImhDigitsOnly)
        self.server_ip.setCursorPosition(0)
        self.server_ip.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.server_ip.setObjectName("server_ip")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.server_ip)
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.server_ip.setInputMask(_translate("LoginWindow", "000.000.000.000"))
        self.server_ip.setText(_translate("LoginWindow", "..."))
        self.label_3.setText(_translate("LoginWindow", "IP сервера"))
