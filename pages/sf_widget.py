...
class Ui_SF_Widget(object):
	def setupUi(self, SF_Widget):
		...
		self.he_pump_led = QtWidgets.QLabel(parent=SF_Widget)
		self.he_pump_led.setGeometry(QtCore.QRect(178, 294, 16, 16))
		font = QtGui.QFont()
		...
		self.he_input_led = QtWidgets.QLabel(parent=SF_Widget)
		self.he_input_led.setGeometry(QtCore.QRect(225, 249, 16, 16))
		font = QtGui.QFont()
		font.setPointSize(20)
		...
		self.he_output_led = QtWidgets.QLabel(parent=SF_Widget)
		self.he_output_led.setGeometry(QtCore.QRect(255, 294, 16, 16))
		font = QtGui.QFont()
		font.setPointSize(20)
		...
		self.high_level_led = QtWidgets.QLabel(parent=SF_Widget)
		self.high_level_led.setGeometry(QtCore.QRect(260, 236, 16, 16))
		font = QtGui.QFont()
		font.setPointSize(20)
		...
		self.output_valve_led = QtWidgets.QLabel(parent=SF_Widget)
		self.output_valve_led.setGeometry(QtCore.QRect(471, 188, 16, 16))
		font = QtGui.QFont()
		font.setPointSize(20)
		...
		self.output_pump_led = QtWidgets.QLabel(parent=SF_Widget)
		self.output_pump_led.setGeometry(QtCore.QRect(547, 188, 16, 16))
		font = QtGui.QFont()
		font.setPointSize(20)
		...
		self.co2_valve_led = QtWidgets.QLabel(parent=SF_Widget)
		self.co2_valve_led.setGeometry(QtCore.QRect(380, 118, 16, 16))
		font = QtGui.QFont()
		font.setPointSize(20)
		...
		self.low_level_led = QtWidgets.QLabel(parent=SF_Widget)
		self.low_level_led.setGeometry(QtCore.QRect(260, 358, 16, 16))
		font = QtGui.QFont()
		font.setPointSize(20)
		...
		self.input_valve_led = QtWidgets.QLabel(parent=SF_Widget)
		self.input_valve_led.setGeometry(QtCore.QRect(254, 188, 16, 16))
		font = QtGui.QFont()
		font.setPointSize(20)
